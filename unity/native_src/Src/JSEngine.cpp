...
JSEngine::JSEngine(void* external_quickjs_runtime, void* external_quickjs_context)
{
    ...
    JSObjectValueGetter = CreateJSFunction(MainIsolate, Context,
...
JSFunction* JSEngine::GetModuleExecutor()
{
    if (ModuleExecutor == nullptr)
    {
        ...
        v8::Context::Scope ContextScope(Context);
        ModuleExecutor = CreateJSFunction(MainIsolate, Context,
...
{
#ifndef WITH_QUICKJS
    v8::platform::RunIdleTasks(BackendEnv._platform, MainIsolate, 10);
#endif
}
